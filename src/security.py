#logica che codifica e decodifica il token
import time
...
def sign_jwt(user_id: int) -> dict[str,str]:
    ...
    #il payload indica quali informazioni conterrà il token
    payload = {
        'user_id': user_id,
        'exp': expiration_time #exp va scritto così perchè jwt chekka un valore con lo stesso nome
    }
